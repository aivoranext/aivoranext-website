    ...
    <section className={cn(
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 text-center sm:gap-12">
        <div className="flex flex-col items-center gap-4 px-4 sm:gap-6">
          ...
          <p className="text-base max-w-[600px] font-medium text-gray-400 sm:text-xl">
            {description}
          </p>
        </div>
        ...
        <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-y-0 left-0 hidden w-1/4 bg-gradient-to-r from-[#050505] sm:block" />
          <div className="pointer-events-none absolute inset-y-0 right-0 hidden w-1/4 bg-gradient-to-l from-[#050505] sm:block" />
        </div>
      </div>
    </section>
  )
