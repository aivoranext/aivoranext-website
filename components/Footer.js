...
const footerSections = {
  services: {
    ...
    links: [
      ...
      { name: "AI Engineer Hiring", href: "/services/ai-hiring" },
    ]
  },
  solutions: {
    title: "Solutions",
      ...
      <div className="border-t border-white/10 pt-16 pb-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
            {/* Services */}
            <div>
              <h4 className="text-white font-semibold text-sm mb-6">{footerSections.services.title}</h4>
            ...
            {/* Solutions */}
            <div>
              <h4 className="text-white font-semibold text-sm mb-6">{footerSections.solutions.title}</h4>
              <ul className="space-y-3">
            ...
            {/* Company */}
            <div>
              <h4 className="text-white font-semibold text-sm mb-6">{footerSections.company.title}</h4>
              <ul className="space-y-3">
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 flex flex-col gap-4 md:items-start lg:items-end">
              <Link
                href="/portfolio"
                className="inline-flex items-center gap-2 px-6 py-3 border border-white/20 hover:border-white/40 text-white text-sm font-medium rounded-full transition-all hover:bg-white/5 group"
              >
                Explore Our Work
      ...
      <div className="border-t border-white/10 pt-12 pb-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-10">
            ...
            {/* Office */}
            <div>
              <h4 className="text-[#0065F8] text-sm font-medium mb-4">Office</h4>
              <p className="text-white text-lg leading-relaxed">
                11th Floor, Krish Cubical, A wing,<br />
                Sindhu Bhavan Marg, Thaltej,<br />
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://twitter.com/aivoranext"
                target="_blank"
              ...
              <a
                href="https://instagram.com/aivoranext"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              <a
                href="https://youtube.com/@aivoranext"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="YouTube"
      ...
      <div className="relative h-[180px] md:h-[240px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 flex justify-center">
          <h2
            ...
            style={{
              background: 'linear-gradient(180deg, rgba(255,255,255,0.9) 0%, rgba(0,101,248,0.8) 50%, rgba(0,101,248,0.4) 100%)',
