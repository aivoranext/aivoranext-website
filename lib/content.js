export const siteConfig = {
  ...
  footerDesc: "We build Agentic AI systems, LLM solutions, Voice AI agents, and enterprise automation. Helping businesses scale with intelligent AI that works 24/7.",
      ...
      categories: [
        {
          name: "AI Development",
          services: [
            { name: "Agentic AI Development", link: "/services/custom-software" },
            { name: "LLM Solutions & Customization", link: "/services/custom-software" },
            { name: "Enterprise LLM Infrastructure", link: "/services/custom-software" },
            { name: "Voice AI Agents", link: "/services/voice-ai" },
            { name: "Intelligent Document Processing", link: "/services/automation" },
            { name: "AI Integrations", link: "/services/custom-software" },
            { name: "Automation & RPA Solutions", link: "/services/automation" },
          ]
        },
        {
          ...
          services: [
            ...
            { name: "Low Code No Code Development", link: "/services/automation" },
            { name: "Cloud Consulting", link: "/services/custom-software" },
            { name: "Cloud Native App Development", link: "/services/custom-software" },
          ]
        },
        {
          name: "UI/UX Design",
        ...
        },
        {
          name: "Hiring",
          services: [
            { name: "Frontend Developer", link: "/services/staff-augmentation" },
            ...
            { name: "Full Stack Developer", link: "/services/staff-augmentation" },
            { name: "Solution Architect", link: "/services/staff-augmentation" },
          ]
        },
      ],
      featuredImages: [
...
export const heroContent = {
  ...
  description: "From Agentic AI and LLM solutions to Voice AI agents and process automation - we build enterprise-ready AI systems that deliver measurable business results.",
...
export const heroTrustedBrands = {
  ...
  brands: [
    { name: "SmartAI", logo: "/logos/smartai.png" },
    { name: "Indemn", logo: "/logos/indemn.png" },
    { name: "SageData", logo: "/logos/sageData.png" },
    { name: "Ideal Electrical", logo: "/logos/idealelectrical.png" },
  ],
};
...
export const belowHeroStatement = {
  ...
  titleStrong: "We build enterprise AI solutions - from Agentic AI and LLM infrastructure to Voice agents and intelligent automation.",
  titleMuted: "Custom SaaS, process automation, email workflows - our AI works around the clock so your team can focus on what matters most.",
  cta: {
...
export const aboutSection = {
  ...
  title2: "AI Partner",
  description: "We're not just another AI vendor. We're your strategic partner for enterprise AI - from Agentic AI development and LLM solutions to Voice AI agents and process automation.",
  subdescription: "Whether you need autonomous AI agents, custom LLM infrastructure, SaaS development, or intelligent email workflows - we deliver measurable results.",
  imageUrl: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=1200&auto=format&fit=crop&q=60",
};
...
export const hireUsSection = {
  ...
  title2: "Get Results.",
  description: "Unlike freelancers, agencies, or building in-house - we deliver production-ready AI solutions that actually work.",
  alternatives: [
    {
      title: "Freelancers",
      problem: "Unreliable timelines, inconsistent quality, and no long-term support. Great for quick fixes, risky for business-critical AI.",
    },
    {
      title: "Generic Agencies",
      problem: "Overpriced, slow-moving, and often lack deep AI expertise. You end up paying for their learning curve.",
    },
    {
      title: "In-House Teams",
      problem: "3-6 months to hire, $200K+ per engineer annually, plus management overhead. Expensive and slow to scale.",
    },
    {
      title: "Off-the-Shelf Tools",
      problem: "Limited customization, vendor lock-in, and features that don't match your specific business needs.",
    },
  ],
  services: [
    {
      ...
      description: "Build autonomous AI agents and customize LLMs for your use cases. From fine-tuning to enterprise infrastructure.",
    },
    {
      icon: "Workflow",
      title: "Process & Email Automation",
      description: "Automate complex workflows with Gen AI. Document processing, email routing, and intelligent task automation.",
    },
    {
      icon: "Phone",
      title: "Voice AI & Communication",
      description: "Build voice agents for 24/7 support and AI-powered content generation for all your communication needs.",
    },
    {
      icon: "Code",
      title: "Custom SaaS & AI Development",
      description: "End-to-end AI-powered software development. From MVPs to scalable SaaS products with AI at the core.",
    },
  ],
  cta: {
...
export const testimonialsSection = {
  ...
  description: "See what businesses are saying about their AI automation journey with us",
  testimonials: [
    {
      author: {
        name: "Sarah Mitchell",
...
export const featureCards = [
  {
    ...
    description: "Build autonomous AI agents that reason, plan, and execute complex multi-step tasks independently. Enterprise-ready agentic systems that scale.",
  ...
  },
  {
    ...
    description: "Fine-tune LLMs for your use cases. Build RAG systems, deploy enterprise LLM infrastructure, and integrate AI into your existing workflows.",
  ...
  },
  {
    ...
    description: "Build conversational voice agents that handle calls 24/7. Customer support, appointment booking, sales calls, and lead qualification on autopilot.",
  ...
  },
  {
    ...
    description: "Transform business processes with AI-powered automation. Automate document processing, data extraction, and complex workflows with intelligent systems.",
  ...
  },
  {
    ...
    description: "End-to-end AI-powered SaaS product development. From MVP to scale, we build modern web applications with AI at the core.",
  ...
  },
  {
    ...
    description: "Cloud consulting, cloud-native app development, and enterprise infrastructure. AWS, Azure, GCP expertise for scalable AI deployments.",
  ...
  },
  {
    ...
    description: "Access top talent for your projects. Frontend, backend, AI developers, designers, and architects to help you build and scale your team.",
  ...
  },
  {
    tag: "UI/UX Design",
    title: "UI/UX Design",
    description: "Create beautiful, intuitive digital experiences that users love. From research and wireframes to high-fidelity designs and interactive prototypes.",
...
export const servicesSection = {
  ...
  services: [
    ...
    },
    {
      ...
      description: "Fine-tune LLMs, build RAG systems, and deploy secure enterprise-ready AI infrastructure.",
    },
    {
      icon: "Workflow",
      title: "Process Automation",
      description: "Transform workflows with generative AI - document processing, data extraction, and intelligent automation.",
    },
    {
      icon: "Phone",
      title: "Voice AI Agents",
      description: "Build voice agents for 24/7 customer support, appointment booking, and sales calls.",
    },
    {
      icon: "Code",
      title: "Custom AI Development",
      description: "End-to-end AI-powered SaaS and custom software development from MVP to scale.",
    },
  ],
  ...
  items: [
    {
      ...
      answer: "Agentic AI refers to autonomous AI systems that can reason, plan, and execute multi-step tasks independently. These agents can handle complex workflows, make decisions, and complete tasks without constant human oversight - perfect for scaling operations.",
    },
    {
      question: "How do you customize LLMs for enterprise use cases?",
      answer: "We fine-tune large language models on your specific data and use cases. This includes building RAG (Retrieval-Augmented Generation) systems, prompt engineering, and deploying private LLM infrastructure that keeps your data secure.",
    },
    {
      question: "What's the typical timeline for building a Voice AI agent?",
      answer: "Basic Voice AI agents can be deployed in 2-3 weeks. This includes voice training, conversation design, integration with your phone system, and testing. More complex implementations with CRM integrations take 4-6 weeks.",
    },
    {
      question: "Can you integrate with our existing systems and tools?",
      answer: "Yes! We integrate with all major CRMs (Salesforce, HubSpot, Pipedrive), communication platforms (Slack, Teams), email systems, and phone systems. Custom API integrations are also available for proprietary systems.",
    },
    {
      question: "How do you ensure data security with LLM infrastructure?",
      answer: "We offer private LLM deployments that keep your data within your infrastructure. Our solutions are compliant with SOC 2, GDPR, HIPAA, and other industry-specific regulations. Full data governance and audit trails included.",
    },
    {
      question: "What's included in Custom SaaS Development?",
      answer: "We provide end-to-end development - from product strategy and MVP to full-scale deployment. This includes AI-native architecture, scalable infrastructure, user experience design, and ongoing support and maintenance.",
    },
  ],
};
...
export const aboutPageContent = {
  ...
  aboutUs: {
    ...
    description: "AivoraNext is an AI solutions company with 8+ years of experience building enterprise-grade AI systems. We specialize in Agentic AI, LLM infrastructure, Voice AI agents, and intelligent automation.",
    mission: "Our mission is to make enterprise AI accessible and practical for businesses of all sizes. We've delivered solutions across Insurance, Banking, Healthcare, and Recruitment - achieving 100% automation rates and 3x faster conversions.",
  },
  techStack: {
  ...
  services: [
    ...
    {
      title: "LLM Solutions & Infrastructure",
      description: "Fine-tune LLMs, build RAG systems, and deploy enterprise-ready LLM infrastructure with full data governance.",
    },
    {
      title: "Process & Email Automation",
      description: "Transform workflows with Gen AI - document processing, email routing, and intelligent task automation.",
    },
    {
      title: "Voice AI & Content Generation",
      description: "Build voice agents for 24/7 support and AI-powered content for marketing, docs, and communications.",
    },
    {
      title: "Custom SaaS Development",
      description: "End-to-end AI-powered SaaS product development from MVP to scale with AI at the core.",
    },
  ],
  stats: [
  ...
  caseStudies: [
    {
      ...
      description: "End-to-end automation of insurance purchase flow achieving 100% automation rate.",
      metrics: ["100% Automation", "Zero Manual Intervention", "24/7 Processing"],
    },
    {
      title: "No-Code AI Agent Platform",
      description: "Built a platform enabling non-technical users to create and deploy AI agents.",
      metrics: ["Drag & Drop Interface", "Pre-built Templates", "One-Click Deploy"],
    },
    {
      title: "Voice AI for Lead Conversion",
      description: "Voice AI system that handles inbound/outbound calls and qualifies leads automatically.",
      metrics: ["3x Faster Conversions", "24/7 Availability", "CRM Integration"],
    },
  ],
};
  ...
  projects: [
    {
      ...
      description: "End-to-end automation of the insurance purchase flow achieving 100% automation rate with zero manual intervention. Built with LangGraph and enterprise LLM infrastructure.",
      tags: ["Automation", "Insurance", "LLM"],
      link: "/portfolio/insurance-purchase-automation",
      client: "Leading Insurance Provider",
      industry: "Insurance",
      duration: "12 weeks",
      challenge: "A major insurance provider was processing thousands of policy purchases manually, leading to delays, errors, and frustrated customers. The manual process took 24-48 hours per application.",
      solution: "We built an end-to-end automated system using LangGraph for orchestration, custom LLM infrastructure for document understanding, and intelligent routing. The system processes applications, validates documents, and issues policies automatically.",
      results: [
        { metric: "Automation Rate", value: "100%", improvement: "From manual processing" },
        { metric: "Processing Time", value: "< 5 minutes", improvement: "From 24-48 hours" },
        { metric: "Error Rate", value: "< 0.1%", improvement: "Near-zero errors" },
        { metric: "Cost Reduction", value: "85%", improvement: "Operational savings" },
      ],
      testimonial: {
        quote: "The automation system has transformed our operations. What took days now happens in minutes, with near-perfect accuracy. Our team can focus on customer relationships instead of paperwork.",
        author: "Operations Director",
        role: "Leading Insurance Provider",
      },
      technologies: ["LangGraph", "LangChain", "OpenAI", "Python", "AWS", "Document AI"],
    },
    {
      id: 2,
      ...
      description: "Built a platform enabling non-technical users to create and deploy AI agents with drag-and-drop interface, pre-built templates, and one-click deployment.",
      tags: ["Platform", "AI Agents", "No-Code"],
      link: "/portfolio/no-code-ai-agent-platform",
      client: "Enterprise SaaS Company",
      industry: "Technology",
      duration: "16 weeks",
      challenge: "Enterprises wanted to leverage AI agents but lacked technical expertise. Building custom agents required ML engineers and months of development, limiting adoption.",
      solution: "We built a no-code platform where business users can create AI agents using a visual builder. Features include pre-built templates, drag-and-drop workflow design, integration marketplace, and one-click deployment to production.",
      results: [
        { metric: "Time to Deploy", value: "< 1 hour", improvement: "From months" },
        { metric: "Technical Skill Required", value: "Zero", improvement: "No coding needed" },
        { metric: "Active Agents", value: "500+", improvement: "Platform adoption" },
        { metric: "User Satisfaction", value: "4.8/5", improvement: "Highly rated" },
      ],
      testimonial: {
        quote: "Our marketing team built their first AI agent in 30 minutes. What would have taken our engineering team weeks to build, business users now do in an afternoon.",
        author: "VP of Product",
        role: "Enterprise SaaS Company",
      },
      technologies: ["React.js", "Node.js", "LangChain", "CrewAI", "PostgreSQL", "AWS"],
    },
    {
      id: 3,
      ...
      description: "Deployed Voice AI agents for a real estate agency handling 2,000+ monthly calls for appointment scheduling and property inquiries. Achieved 3x faster lead conversions.",
      ...
      solution: "We deployed a Voice AI agent using LiveKit and ElevenLabs that handles inbound calls 24/7. The AI qualifies leads, schedules property viewings, answers FAQs about listings, and seamlessly transfers hot leads to available agents.",
      results: [
        { metric: "Response Time", value: "< 3 seconds", improvement: "From 4+ hours" },
        { metric: "Lead Conversion", value: "3x faster", improvement: "Significant improvement" },
        { metric: "Agent Productivity", value: "3x", improvement: "More closings per agent" },
        { metric: "Cost Savings", value: "$15K/mo", improvement: "Reduced staffing needs" },
      ],
      testimonial: {
      ...
      technologies: ["LiveKit", "ElevenLabs", "Twilio", "Salesforce CRM", "Calendar Integration"],
    },
    {
      id: 4,
